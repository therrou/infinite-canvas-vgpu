...
export function capsuleData(spec) {
...
function capsuleSmoothData(spec) {
    ...
    for (let row = 0; row < rows; row++)
        addRow(vertices, spec, row, total);
...
function addRow(vertices, spec, row, total) {
...
//# sourceMappingURL=capsule-data.js.map