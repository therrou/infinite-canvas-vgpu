import { normalized, pushVertex, toFlatTriangles } from "./primitive-data-utils.js";
export function coneData(spec) {
...
function addBaseCap(vertices, indices, spec) {
    ...
    for (let i = 0; i < radialSegments; i++)
        indices.push(center, rim + i + 1, rim + i);
}
//# sourceMappingURL=cone-data.js.map