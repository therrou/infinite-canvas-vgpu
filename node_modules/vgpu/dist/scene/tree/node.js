import { sceneCycleError, sceneValueError } from "./errors.js";
import { composeTrs, copyMat4, identityMat4, invertAffineMat4, multiplyMat4, quatFromEuler, quatLookAt, transformDirection, transformPoint, } from "./math.js";
...
export class SceneNode {
    ...
    #markWorldDirty(force = false) {
        if (this.#worldDirty && !force)
            return;
