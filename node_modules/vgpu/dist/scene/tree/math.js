...
export function copyMat4(out, m) {
    out.set(m);
    return out;
}
/** out = position/quaternion/scale composed into a column-major TRS matrix. */
export function composeTrs(out, position, quaternion, scale) {
...
export function invertAffineMat4(out, m) {
...
export function transformDirection(out, m, v) {
...
export function quatFromEuler(out, x, y, z) {
...
export function multiplyQuat(out, a, b) {
...
export function conjugateQuat(out, q) {
    out[0] = -q[0];
    out[1] = -q[1];
    out[2] = -q[2];
    out[3] = q[3];
...
export function quatFromBasis(out, m00, m01, m02, m10, m11, m12, m20, m21, m22) {
...
export function quatLookAt(out, eye, target, up) {
...
export function quatFromMat4Rotation(out, m) {
    const sx = Math.hypot(m[0], m[1], m[2]) || 1;
    const sy = Math.hypot(m[4], m[5], m[6]) || 1;
    const sz = Math.hypot(m[8], m[9], m[10]) || 1;
    return quatFromBasis(out, m[0] / sx, m[1] / sx, m[2] / sx, m[4] / sy, m[5] / sy, m[6] / sy, m[8] / sz, m[9] / sz, m[10] / sz);
}
