...
import { attachKernel } from "./kernel.js";
import { assertDeviceUsable } from "./lifecycle.js";
import { VGPUError } from "./errors.js";
/**
 ...
 */
export async function initFromDevice(device) {
    if (!isGPUDeviceShape(device))
        throw initError("VGPU-INIT-DEVICE-INVALID", "Invalid external GPUDevice shape.");
    const wrapped = new Device(device, null, "external");
...
function isGPUDeviceShape(value) {
    ...
    try {
        ...
        return (typeof d.queue === "object" || typeof d.queue === "function") && d.queue !== null
            ...
            && !!d.lost && typeof d.lost.then === "function";
    }
    catch {
        return false;
    }
...
function initError(code, message) { return new VGPUError({ code, message, where: "initFromDevice" }); }
//# sourceMappingURL=init-from-device.js.map