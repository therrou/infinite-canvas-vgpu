 ...
 */
export declare function entryMetadata<K extends "bindings" | "samplingPairs" | "inputs">(entry: EntryPointInfo, field: K, where: string): NonNullable<EntryPointInfo[K]>;
//# sourceMappingURL=entry-metadata.d.ts.map