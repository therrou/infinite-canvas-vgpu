...
export declare const BINDING_RESOURCE: unique symbol;
/**
...
export declare function bindingResourceOf(value: unknown): BindingResourceProvider | undefined;
/** @internal Resolves named geometry attributes against reflected shader inputs. */
export declare const geometryLayoutResolver: unique symbol;
...
//# sourceMappingURL=draw-protocols.d.ts.map