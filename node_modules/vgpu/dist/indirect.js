...
import { indirectInvalidError } from "./errors.js";
/**
 ...
 * @internal
 */
export function resolveIndirect(label, where, value, method) {
    const wrapped = typeof value === "object" && value !== null ? value.buffer : undefined;
