...
export function storageStageLimitError(label, stage, entryPoint, count, limit, bindings) {
...
export function textureFilterabilityError(label, binding, format, resourceName, sampler) {
    return new VGPUError({
...
export function neverSetError(drawLabel, binding) {
...
export function ownershipFlipError(name, previous) {
...
export function claimedGroupSetError(label, group) {
    return new VGPUError({
...
export function claimedGroupIncompatibleError(label, group, reason, cause) {
    return new VGPUError({
...
export function claimedGroupNativeValidationError(label, group, cause) {
    return new VGPUError({
...
export function blendInvalidError(label, value) {
    return new VGPUError({
...
export function blendConstantInvalidError(label, reason) {
    return new VGPUError({
...
export function bundleBlendConstantError(bundleId, drawLabel) {
    return new VGPUError({
...
export function writeMaskInvalidError(label, preview) {
    return new VGPUError({
...
export function colorsInvalidError(label, reason, where = "draw") {
    return new VGPUError({
...
export function cullInvalidError(label, value) {
    return new VGPUError({
...
export function frontFaceInvalidError(label, value) {
    return new VGPUError({
...
export function unclippedDepthInvalidError(label, reason) {
    return new VGPUError({
...
export function depthInvalidError(label, reason) {
    return new VGPUError({
...
export function stencilInvalidError(label, reason, where = "draw") {
    return new VGPUError({
...
export function bundleStencilReferenceError(bundleId, drawLabel) {
    return new VGPUError({
...
export function multisampleInvalidError(label, reason, where = "draw") {
    return new VGPUError({
...
export function constantsInvalidError(label, reason, where = "draw") {
    return new VGPUError({
...
export function entryInvalidError(label, reason, where = "draw") {
    return new VGPUError({
...
export function indirectInvalidError(label, reason, where) {
    return new VGPUError({
...
export function passPreserveMsaaError() {
    return new VGPUError({
...
export function passClearDepthInvalidError(value, reason = "expected a number in [0, 1].", fix = `Use 1 (default), or 0 with depth: { compare: "greater" } for reversed-Z.`) {
    return new VGPUError({
...
export function passViewportInvalidError(reason) {
    return new VGPUError({
...
export function passScissorInvalidError(reason) {
    return new VGPUError({
...
export function passPreserveClearDepthError() {
    return new VGPUError({
...
export function passClearStencilInvalidError(reason) {
    return new VGPUError({
...
export function passPreserveClearStencilError() {
    return new VGPUError({
...
export function passDepthReadOnlyError(reason, fix, where = "Frame.pass") {
    return new VGPUError({
...
export function passDepthReadOnlyMsaaError() {
    return new VGPUError({
...
export function timerInvalidError(reason, fix, where = "timer") {
    return new VGPUError({
...
export function timerCapacityError(maxSpans, maxQueries) {
    return new VGPUError({
...
export function visibilityInvalidError(reason, fix, where = "visibility") {
    return new VGPUError({
...
export function visibilityCapacityLimitError(value, maxQueries) {
    return new VGPUError({
...
export function visibilityCapacityError(capacity) {
    return new VGPUError({
...
export function visibilityLabelDuplicateError(label) {
    return new VGPUError({
...
export function visibilityDisposedError(what, where) {
    return new VGPUError({
...
export function visibilityNoDepthError() {
    return new VGPUError({
...
export function queryNoVisibilityError() {
    return new VGPUError({
...
export function queryNestedError() {
    return new VGPUError({
...
export function queryDuplicateError(label) {
    return new VGPUError({
...
export function targetRequiredError(where = "Frame.pass") {
    return new VGPUError({
...
export function meshLayoutInvalidError(where, message) {
...
export function meshLimitExceededError(where, message) {
    return meshError("VGPU-MESH-LIMIT-EXCEEDED", where, message, "Use <= 8 buffers and <= 16 attributes (or the device limits).");
}
export function meshLocationConflictError(where, location) {
...
export function meshDataMisalignedError(where, message) {
...
export function meshRangeInvalidError(where, message) {
...
export function meshAttributeAmbiguousError(where, name, locations) {
...
export function meshInputMissingError(where, name, available = []) {
...
export function meshFormatMismatchError(where, name, meshFormat, shaderType) {
...
export function pipelineLayoutGapError(group) {
    return new VGPUError({
...
export function compileFailedError(where, cause, signature) {
    return new VGPUError({
...
export function compileDisposedError(where) {
    return new VGPUError({
...
export function compileSignatureInvalidError(where, reason) {
    return new VGPUError({
...
export function targetStencilOnlyDepthError(format) {
    return new VGPUError({
...
export function targetSizeRequiredError() {
    return new VGPUError({
...
export function surfaceNotInFrameError(where) {
    return new VGPUError({
...
export function surfaceContextError() {
    return new VGPUError({
...
export function surfaceDuplicateError(label) {
    return new VGPUError({
...
export function surfaceDisposedError(label) {
    return new VGPUError({
...
export function surfaceAutoResizeUnsupportedError() {
    return new VGPUError({
...
export function surfaceResizeReentrantError(label) {
    return new VGPUError({
...
export function clearColorInvalidError(where) {
    return new VGPUError({
...
export function clockDeltaInvalidError(received) {
    return new VGPUError({
...
export function frameReentrantError() {
    return new VGPUError({
 ...
 */
export function queryReadbackError(label, cause) {
    return new VGPUError({
...
export function frameCanceledError(where) {
    return new VGPUError({
...
export function framePassActiveError(where) {
    return new VGPUError({
...
export function frameAlreadySubmittedError(where) {
    return new VGPUError({
...
export function incompatibleResourceError(binding, expected, fix) {
    return new VGPUError({
...
export function unsupportedError(where, message, fix) {
    return new VGPUError({ code: "VGPU-RING1-UNSUPPORTED", message, fix, where });
}
export function malformedShaderSourceError(input) {
...
export function writableStorageAliasingError(where) {
    return new VGPUError({
