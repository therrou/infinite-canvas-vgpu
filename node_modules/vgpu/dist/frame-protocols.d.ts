...
export declare const FRAME_DRAWABLE: unique symbol;
...
export declare function frameDrawableOf(value: unknown): FrameDrawableProtocol | undefined;
export declare const FRAME_BUNDLE: unique symbol;
...
export declare function frameBundleOf(value: unknown): FrameBundleProtocol | undefined;
/**
...
export declare const FRAME_PASS_ATTACHMENT: unique symbol;
...
export declare function framePassAttachmentOf(value: unknown): FramePassAttachment | undefined;
//# sourceMappingURL=frame-protocols.d.ts.map