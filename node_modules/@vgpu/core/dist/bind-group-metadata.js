...
const bindGroupMetadata = new WeakMap();
/**
 ...
 * public shape.
 */
export function attachBindGroupLayoutMetadata(layout, metadata) {
...
export function bindGroupLayoutMetadata(layout) {
 ...
 */
export function attachBindGroupMetadata(bindGroup, layout) {
    const metadata = bindGroupLayoutMetadata(layout);
    if (metadata)
        bindGroupMetadata.set(bindGroup, { layout: metadata });
    return bindGroup;
}
/** Returns descriptor metadata previously attached to a bind group, if vgpu knows it. */
export function bindGroupMetadataFor(bindGroup) {
...
//# sourceMappingURL=bind-group-metadata.js.map