...
export type BufferUsageName = "map_read" | "map_write" | "copy_src" | "copy_dst" | "index" | "vertex" | "uniform" | "storage" | "indirect" | "query_resolve";
export interface BufferOptions {
    readonly size: number;
    readonly usage: readonly BufferUsageName[];
    readonly label?: string;
}
export type RequiredDeviceLimits = Partial<{
    readonly [K in keyof GPUSupportedLimits]: GPUSize64;
}>;
