...
export interface AliasInfo {
    readonly name: string;
    readonly mangledName: string;
    readonly target: WGSLType;
}
export interface StructInfo {
    readonly name: string;
    readonly mangledName: string;
    readonly members: readonly StructMemberInfo[];
}
...
export type ReflectedBindingLayout = {
    ...
    readonly externalTexture: Record<string, never>;
};
export type WGSLType = {
    readonly kind: "scalar";
    readonly name: ScalarKind;
} | {
    readonly kind: "atomic";
    readonly element: WGSLType;
} | {
    ...
    readonly kind: "texture";
    readonly textureKind: string;
    readonly dimension?: TextureDimension;
    readonly sampleType?: WGSLType;
    readonly texelFormat?: string;
    readonly access?: AccessMode;
} | {
...
export type ParsedStructMember = StructMemberInfo & {
    readonly attrs: readonly Attr[];
};
export type ParsedStruct = Omit<StructInfo, "members"> & {
    readonly path: string;
    readonly originalName: string;
    readonly members: readonly ParsedStructMember[];
};
export type ParsedAlias = AliasInfo & {
    readonly path: string;
    readonly originalName: string;
};
export type EntryPointParam = {
    readonly name: string;
    readonly attrs: readonly Attr[];
    readonly type: WGSLType;
};
...
export type SymbolTarget = {
    ...
    readonly name: string;
    readonly mangledName: string;
    readonly kind: "struct" | "alias" | "namespace";
};
...
//# sourceMappingURL=reflect-types.d.ts.map