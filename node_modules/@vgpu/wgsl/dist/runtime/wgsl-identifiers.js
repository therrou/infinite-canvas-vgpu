...
export const WGSL_SPEC_KEYWORDS = new Set([
...
export const VGPU_MODULE_KEYWORDS = new Set(["import", "export", "from", "as"]);
export const WGSL_KEYWORDS = new Set([...WGSL_SPEC_KEYWORDS, ...VGPU_MODULE_KEYWORDS]);
...
export const WGSL_LEGACY_RESERVED_WORDS = new Set(["binding_array"]);
export const WGSL_PREDECLARED_TYPES = new Set([
...
export const WGSL_PREDECLARED_VALUES = new Set([
...
export const WGSL_BUILTIN_VALUES = new Set([
...
export const WGSL_ADDRESS_SPACE_NAMES = new Set(["function", "private", "storage", "uniform", "workgroup"]);
export const WGSL_ACCESS_MODE_NAMES = new Set(["read", "read_write", "write"]);
export const WGSL_TEXEL_FORMAT_NAMES = new Set([
...
export const WGSL_RENAME_FORBIDDEN_IDENTIFIERS = new Set([
    ...WGSL_KEYWORDS,
    ...WGSL_RESERVED_WORDS,
...
export function isWgslRenameForbiddenIdentifier(name) {
    return WGSL_RENAME_FORBIDDEN_IDENTIFIERS.has(name);
}
//# sourceMappingURL=wgsl-identifiers.js.map