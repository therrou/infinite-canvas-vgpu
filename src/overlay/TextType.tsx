...
export interface TextTypeProps extends HTMLAttributes<HTMLElement> {
  ...
  readonly hideCursorWhileTyping?: boolean;
  ...
  readonly variableSpeed?: VariableSpeed;
  readonly onSentenceComplete?: (sentence: string, index: number) => void;
